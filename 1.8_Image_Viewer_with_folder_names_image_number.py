...
import fitz,json,os,sys,threading,requests,os,sys,shutil,subprocess,time,zipfile
...
# image Viewer updated with Print Option , fixed image resize to boxes, folder name how image number too 
