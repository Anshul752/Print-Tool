...
def load_first_page_for_crop():
    try:
        ...
        messagebox.showerror("Error", f"Unable to process PDF: {e}")
...
def show_crop_preview(original_image, card_side):
    ...
    def reset_crop():
        nonlocal zoom_factor
        angle_var.set(0)
        zoom_factor = min(1.0, preview_frame.winfo_width() / image_width)
        update_canvas_image(get_transformed_image())
        points.clear()
...
# New_crop_and_print_with_new_2_new_A4_Paper
