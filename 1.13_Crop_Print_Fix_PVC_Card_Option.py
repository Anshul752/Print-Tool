...
epson_photo_plus_path = r"C:\Users\1067329\AppData\Local\Programs\Microsoft VS Code\Code.exe"  # <-- Your path
Print_Data_Folder = r"C:\RJIO\Vivo\Print Data" # Define Print Data folder
...
def wait_for_program():
    def update_timer():
        ...
        if seconds_left > 0:
            label.config(text=f"Waiting For Program to Open... {seconds_left} sec")
            seconds_left -= 1
...
def open_epson_photo_plus():
    ...
    windows = gw.getWindowsWithTitle("Visual Studio Code")  # Replace with actual window title
    if windows:
        ep_window = windows[0]
    ...
    if user_response == 'Yes':
        ...
        # 15. Reopen file dialog after user selects "Yes" for the back image
        pyautogui.keyDown('ctrl')
        pyautogui.press('o')
        pyautogui.keyUp('ctrl')
...
paper_dropdown["values"] = ["4x6 Paper", "A4 Paper","A4 Paper U+D","A4 Paper L+R","PVC Card"]#"A4 Paper Full"
